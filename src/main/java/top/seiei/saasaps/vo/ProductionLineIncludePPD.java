...
public class ProductionLineIncludePPD {
    ...
    private List<ProductionPlanningDetail> productionPlanningDetailList;
    ...
    public List<ProductionPlanningDetail> getProductionPlanningDetailList() {
        return productionPlanningDetailList;
    }
